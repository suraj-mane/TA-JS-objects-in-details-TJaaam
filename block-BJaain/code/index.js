...
myFunction(); // Window {window: Window, self: Window, document: document, name: '', location: Location, …} this display the window
...
foo(); // Simple function call , 3 true
...
(function () {
  ...
  console.log(this === window);
})(); // Anonymous function invocation ,3 true
...
myObject.someMethod(); // function and undifined.
...
person.displayName.call(person2); // person2 is not defined
...
// getThis getThis1 getThis2 getThis3 getThis4
obj.getThis2();
...
console.log(printNameBob()); // undefined
